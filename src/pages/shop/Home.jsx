...
const Home = () => {
        ...
        <div className="flex flex-col">
            ...
            <div className="bg-white">
                <motion.div
                    ...
                    className="container mx-auto pt-[70px] pb-[100px] px-2 flex flex-col items-center"
                >
    ...
    <div className="bg-primary text-white">
        ...
        <div className="bg-white">
            <div className="container mx-auto pt-[70px] pb-[60px]">
                <div className="flex flex-col md:flex-row justify-between gap-10">
                    ...
                    <motion.div
                        ...
                        viewport={{once: true}}
                        transition={{duration: 0.6}}
                        className="flex justify-end rounded-lg overflow-hidden w-full md:w-1/3"
                    >
                        <img
        ...
        <div className="bg-white">
            <div className="container mx-auto pt-[40px] pb-[100px]">
                <div className="flex flex-col md:flex-row justify-between gap-10">
                    <motion.div
                        initial={{opacity: 0, x: -50}}
                        whileInView={{opacity: 1, x: 0}}
