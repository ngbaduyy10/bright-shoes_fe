    ...
    return (
        <>
            <Sheet open={open} onOpenChange={setOpen}>
                <SheetContent side="left" className="w-64 bg-primary text-white border-0">
                    <div className="flex flex-col h-full">
                        <SheetHeader className="flex flex-col justify-center h-[80px] p-5">
                        ...
                        <div className="flex flex-col items-center gap-2">
                            {adminSidebarMenuItems.map((menuItem) => (
                                <div
                                    ...
                                    className={`flex cursor-pointer text-lg items-center gap-2 rounded-md py-2 px-5 w-full
            ...
            <aside className="hidden flex-col bg-primary text-white lg:flex w-64">
                <div className="flex items-center gap-2 p-5 h-[80px]">
                    <ChartNoAxesCombined size={28}/>
                    <div className="text-2xl font-extrabold">Admin Panel</div>
                </div>
